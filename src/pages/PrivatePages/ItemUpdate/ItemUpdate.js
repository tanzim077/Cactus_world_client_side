            ...
            <form className="col-lg-6 d-flex mx-auto flex-column gap-2" onSubmit={handleUpdate}>
                <div className="form-group row">
                    ...
                    <div className="col-sm-8">
                        <input className="form-control" onChange={nameChange} type="text" value={item.itemName || ''} />
                    </div>
                </div>
                <div className="form-group row">
                    <label for="staticEmail" className="col-sm-4 col-form-label">Image URL</label>
                    <div className="col-sm-8">
                        <input className="form-control" onChange={imageChange} type="text" value={item.image || ''} />
                    </div>
                </div>
                <div className="form-group row">
                    <label for="staticEmail" className="col-sm-4 col-form-label">Cost</label>
                    <div className="col-sm-8">
                        <input className="form-control" onChange={priceChange} type="number" value={item.price || ''} />
                    </div>
                </div>
                <div className="form-group row">
                    <label for="staticEmail" className="col-sm-4 col-form-label">Description</label>
                    <div className="col-sm-8">
                        <input className="form-control" onChange={descriptionChange} type="text" value={item.description || ''} />
                    </div>
                </div>
                <div className="form-group row">
                    <label for="staticEmail" className="col-sm-4 col-form-label">Extra /Tag</label>
                    <div className="col-sm-8">
                        <input className="form-control" onChange={originChange} type="text" value={item.origin || ''} />
                    </div>
                </div>
