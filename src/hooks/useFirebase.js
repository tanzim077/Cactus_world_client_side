...
const useFireBase = () => {
    ...
    useEffect(() => {
        axios.get(`https://mighty-crag-94651.herokuapp.com/users/${user.email}`)
    ...
    const saveUser = (email, displayName, method) => {
        ...
        if (method === 'post') {
            axios.post('https://mighty-crag-94651.herokuapp.com/users/create', user)
        }
        else if (method === 'put') {
            axios.put('https://mighty-crag-94651.herokuapp.com/users/create', user)
        }
